...
export const CAR_PARTS: CarPart[] = [
  ...
  { name: 'Left Front Wheel Rim', area: 'Front', cameras: [], bestCamera: '', bestFrameNum: 0 },
  ...
  { name: 'Left Rear Wheel Rim', area: 'Left', cameras: [], bestCamera: '', bestFrameNum: 0 },
  ...
  { name: 'Right Front Wheel Rim', area: 'Right', cameras: [], bestCamera: '', bestFrameNum: 0 },
  ...
  { name: 'Right Rear Wheel Rim', area: 'Right', cameras: [], bestCamera: '', bestFrameNum: 0 },
